    ...
    * */
    ...
    static {
        if (System.getenv("environment") != null &&
            ...
            GMAIL_PASSWORD = System.getenv("GMAIL_PASSWORD");
            ...
            REDIRECT_URL_BASE = "http://localhost:8080";
            TISENSOR_REST_URL = "http://localhost:8081/tisensor";
            FITBIT_OAUTH_CLIENT_ID = "227L87";
            APP_CLIENT_ID_AND_SECRET =
                    "MjI3TDg3OjgxMDYzNTYyYzdiMzZlZmVjMWYzNGY5Y2FhMmNlNTdk";
            GMAIL_USERNAME = "SET IT YOURSELF";
            GMAIL_PASSWORD = "SET IT YOURSELF";
            DATABASE_NAME = "mydb";
            DATABASE_USERNAME = "";
            DATABASE_PASSWORD = "";
